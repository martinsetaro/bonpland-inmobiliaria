    ...
    <div className='w-full h-auto'>
      <div className='w-full h-32 flex'>
         <div className='w-1/4 p-4'>
           <Image className='mt-5' src={logo} width={190} height={160} alt="logo"/>
         </div>
         <div className='w-full flex justify-around items-center'>
           <h2>Telefono : 23444445353</h2>
           <h2>Horarios de atención: Lun a Vie 9:00 a 16:00</h2>
           <span className='flex gap-2 p-2 border border-slate-500 items-center rounded-md cursor-pointer'>
              <FaUser/>
              <h2>Login</h2>
           </span>
         </div>
      </div>
      <nav className='w-full h-12 bg-slate-700 flex justify-around text-white items-center'>
